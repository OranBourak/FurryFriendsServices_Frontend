...
const Times = (props) => {
    ...
    const blockDay = async () => {
        ...
        // TODO: Add logic for removing the blocked timeslots object from the db if the user blocked specific hours on that date
        try {
        ...
        props.setIsAfterBlockOperation(true);
    };
